...
;( function( window ) {
	...
	grid3D.prototype._init = function() {
        ...
        this.griditemswrap = this.grid.querySelector( '.cbp-wrapper' );
    
		this.gridItems = [].slice.call( this.griditemswrap.children);
	...
	grid3D.prototype._hideContent = function() {
        ...
        var res = document.getElementById('idclose').title.split("/"); 
        this.placeholder.style.left = res[0]+'px';
		this.placeholder.style.top =  res[1]+'px';
		this.placeholder.style.width = this.itemSize.width + 'px';
		this.placeholder.style.height = this.itemSize.height + 'px';
        
        //document.getElementById(res[2]).style.opacity = "1.0";
