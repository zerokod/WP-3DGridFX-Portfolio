...
class wpstreamp__OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'wp-3DgridFX-portfolio'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'wp-3DgridFX-portfolio'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'wp-3DgridFX-portfolio'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'wp-3DgridFX-portfolio'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'wp-3DgridFX-portfolio');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'wp-3DgridFX-portfolio'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'wp-3DgridFX-portfolio');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'wp-3DgridFX-portfolio'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'wp-3DgridFX-portfolio') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'wp-3DgridFX-portfolio');
            case 'false':
                return __('false', 'wp-3DgridFX-portfolio');

            case 'Administrator':
                return __('Administrator', 'wp-3DgridFX-portfolio');
            case 'Editor':
                return __('Editor', 'wp-3DgridFX-portfolio');
            case 'Author':
                return __('Author', 'wp-3DgridFX-portfolio');
            case 'Contributor':
                return __('Contributor', 'wp-3DgridFX-portfolio');
            case 'Subscriber':
                return __('Subscriber', 'wp-3DgridFX-portfolio');
            case 'Anyone':
                return __('Anyone', 'wp-3DgridFX-portfolio');
        }
        return $optionValue;
    }
...
public function outputTab1Contents() {
	...
	?>
            <h2><?php _e('ADD CATEGORY', 'wp-3DgridFX-portfolio'); ?></h2>
            ...
            <form method="post" action="" id="targetcat" >
                ...
                <table class="form-table"><tbody>
                             ...
                             <tr valign="top">
                                <th scope="row"><input type="hidden" name="addcategory" id="addcategory" value="1" /><p> <label for="category"><?php _e('Category', 'wp-3DgridFX-portfolio'); ?></label></p>
                                <p> <input type="text" 
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Add category', 'wp-3DgridFX-portfolio'); ?>" id="addcatsubmit" />
                </p>
            </form>
            <h2><?php _e('CATEGORIES', 'wp-3DgridFX-portfolio'); ?></h2>
            ...
            */
            jQuery(document).ready(function() {
        		...
        		jQuery(".removecategory").each(function(index) {
        			...
        			jQuery.post( currentdomain[0]+"/wp-content/plugins/wp-3DgridFX-portfolio/wpstreamp_Actions3.php", { 
        				idcategory: e
        				 })
        			.done(function( data ) {
        			...
        			window.location.href = window.location.href.replace( /[\?#].*|$/, "?page=wpstreamp__PluginSettings" );
        /*
        ...
        */
            	...
            	jQuery( "#targetcat" ).submit(function( event ) {
        			...
        			// /ericolisboa/wp-content/plugins/wp-3DgridFX-portfolio/wpstreamp_Actions.php
        			jQuery.post( currentdomain[0]+"/wp-content/plugins/wp-3DgridFX-portfolio/wpstreamp_Actions.php", { 
...
public function outputTab2Contents() {
	...
	?>
	<p> <label for="category"><?php _e('Portfolio Items', 'wp-3DgridFX-portfolio'); ?></label></p><div id="loadresponse3"></div>
	 <table  class="form-table"><tbody>
                                ...
                                <tr valign="top">
                                		<td><p> <label for="category"><?php _e('Categories', 'wp-3DgridFX-portfolio'); ?>
                                	</label></p>
                                	  </td>
                                	  <td><p> <label for="category"><?php _e('title', 'wp-3DgridFX-portfolio'); ?>
                                		</label></p>
                                	  </td>
                                	   <td><p> <label for="category"><?php _e('description', 'wp-3DgridFX-portfolio'); ?>
                                		</label></p>
                                	  </td>
                                	  <td><p> <label for="category"><?php _e('work', 'wp-3DgridFX-portfolio'); ?>
                                		</label></p>
                                	  </td>
                                	  <td><p> <label for="category"><?php _e('image', 'wp-3DgridFX-portfolio'); ?>
                                		</label> 
                                		</p>
                                	  </td>
                                	  <td><p> <label for="category"><?php _e('actions', 'wp-3DgridFX-portfolio'); ?>
                                		</label>
                                		</p>
                                	  </td>
                                	  </tr>
                 ...
                 $i=0;
                           ...
                           value="<?php _e('Delete item', 'wp-3DgridFX-portfolio'); ?>" id="deleteitem<?php
   								 		echo $i;
   								 		?>"/>
                                		</p><p>  <input type="button" class="button-primary-modify"
                           value="<?php _e('Modify item', 'wp-3DgridFX-portfolio'); ?>" id="modifyitem<?php
   								 		echo $i;
   								 		?>" />
                                		</p>
                                	  </td>
...
jQuery(document).ready(function(){
		...
		jQuery(this).click(function(){
			...
			window.location.href = window.location.href.replace( /[\?#].*|$/, "?page=wpstreamp__PluginSettings&tabx=portfolioall" );
		...
		jQuery(".button-primary-modify").each(function(index) {
			...
			jQuery(this).click(function(){
				...
				//alert(iditemportfolio1 );
					...
					window.location.href = window.location.href.replace( /[\?#].*|$/, "?page=wpstreamp__PluginSettings&tabx=portfolioid&id="+iditemportfolio1 );
				  });
...
public function outputTab3Contents() {
	...
	?>
            <h2><?php _e('ADD PORTFOLIO ITEM', 'wp-3DgridFX-portfolio'); ?></h2>
<div id="loadresponse2"></div>
            <form method="POST"  action="" id="targetportfolio" name="test_form">
                ...
                <table class="form-table"><tbody>
                            ...
                            <tr valign="top">
                                <th scope="row"><p> <input type="hidden" name="modportfolioitem" id="modportfolioitem" value="<?php echo $id;?>" /><input type="hidden" name="addportfolio" id="addportfolio" value="1" /><label for="category"><?php _e('Category', 'wp-3DgridFX-portfolio'); ?></label></p><p>
                           ...
                           value="<?php _e('Add Categories', 'wp-3DgridFX-portfolio'); ?>" id="addcategories" onclick="listbox_moveacross('allcat', 'cat');" />
                                ...
                                ?>
                                    ...
                                    <input type="button" 
                           value="<?php _e('Remove Categories', 'wp-3DgridFX-portfolio'); ?>" id="removecategories" onclick="listbox_moveacross('cat', 'allcat');"/>
   </p></th>
                                <td>
                             ...
                             <tr valign="top">
                                <th scope="row"><p> <label for="title"><?php _e('Title', 'wp-3DgridFX-portfolio'); ?></label></p><p>
                                 <input type="text" 
                           value="<?php echo $response1;?>" name="title" id="title"/></p></th>
                               ...
                               <tr valign="top">
                                <th scope="row"><p> <label for="description"><?php _e('description', 'wp-3DgridFX-portfolio'); ?></label></p>
                             ...
                             <tr valign="top">
                                <th scope="row"><p> <label for="Work"><?php _e('Work', 'wp-3DgridFX-portfolio'); ?></label></p><p> <input type="text" 
                           value="<?php echo $response3;?>" name="work" id="work"/></p></th>
                             ...
                             <tr valign="top">
                                <th scope="row"><p> <label for="Image"><?php _e('Image', 'wp-3DgridFX-portfolio'); ?></label></p>
...
<br />
		...
		<table class="widefat">
			<thead>
				<tr><th colspan="2"><?php _e('Upload Files', 'wp-3DgridFX-portfolio'); ?></th></tr>
			</thead>
			<tr>
				<td width="150"><span class="field_name"><?php _e('Image Location', 'wp-3DgridFX-portfolio'); ?></span></td>
				<td>
				<input type="text"  name="image_location" value="<?php echo $response4;?>" size="40"  id="image_location"/>
				<input type="button" class="onetarek-upload-button button" value="<?php _e('Upload Image', 'wp-3DgridFX-portfolio'); ?>" />
				<br /><span><?php _e('Enter the image location or upload an image from your computer.', 'wp-3DgridFX-portfolio'); ?></span>
				</td>
			</tr>
...
<br />
 ...
 ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Add Portfolio Item', 'wp-3DgridFX-portfolio'); ?>"/>
                </p>
            ...
            jQuery(document).ready(function() {
                ...
                jQuery( "#targetportfolio" ).submit(function( event ) {
        			...
        			//alert( "Data Loaded: " + data );
        				...
        				jQuery.post( currentdomain[0]+"/wp-content/plugins/wp-3DgridFX-portfolio/wpstreamp_Actions2.php", { 
